...
<body>
	...
	String mobNum = user.getPhoneNumber() != null ? user.getPhoneNumber() : "";
	String address = user.getUserAddress() != null ? user.getUserAddress() : "";
	%>
				...
				<div class="bottomcontent">
					...
					<div class="inputfields">
						<label for="fname">First name<input type="text" required
							id="fname" value="<%=user.getUserName()%>" name="fname" disabled>
						</label> <br> 
						 <br> <label for="email"> Email <input type="email"
							name="email" id="email" value="<%=user.getEmailId()%>" readonly>
