...
<body>
    ...
    <main>
        <div class="amd">
            ...
            <p>Astigmatism is an imperfection in the curvature of your eye's cornea or lens.<br> With astigmatism your
                vision is blurry at all distances.</p>
        </div>
        <div class="test">
            <p class="h_three">Close Your Left Eye<br><br><br>Q. Do you see any sharper or darker/bolder line in any of
                the sets below?</p>
            <div class="choose">
                <img src="../../asset/images/home_eye_test/astigmatism-quiz.svg" alt="" style="margin-top: 100px;">
                <form>
        ...
        <div class="test">
            <p class="h_three">Close Your Right Eye<br><br><br>Q. Do you see any sharper or darker/bolder line in any of
                the sets below?</p>
            <div class="choose">
                <img src="../../asset/images/home_eye_test/astigmatism-quiz.svg" alt="" style="margin-top: 100px;">
                <form id="form">
