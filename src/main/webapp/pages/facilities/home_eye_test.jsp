...
<body>
   ...
   <main>
        ...
        <div class="eye_screening">
            <p>Eye Screening</p>
            <a href="../facilities/eye_screening.html"><button type="submit">Let's Start</button></a> 
        </div>
        <div class="amd">
            ...
            <a href="../facilities/amd.html"><button type="submit" id="btn">Let's Start</button></a>
        </div>
        <div class="amd">
           ...
           <a href="../facilities/astigmatism.html"><button type="submit" id="btn">Let's Start</button></a>
        </div>
        <div class="amd">
            ...
            <a href="../facilities/near_vision.html"><button type="submit" id="btn">Let's Start</button></a>
        </div>
        <div class="amd">
            <div class="book_now">            
                <img src="../../asset/images/home_eye_test/Home-eye-test_1.png" alt="amd" >
                <a href="../order/book_now.html"><button type="submit" id="btn">Book Now</button></a>
            </div>
        </div>
    </main>
    <footer>
