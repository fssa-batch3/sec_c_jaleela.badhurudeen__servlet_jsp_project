...
<head>
    ...
    <link rel="stylesheet" href="../../asset/css/product_one.css">
    ...
    <main>
        <!-- <div class="container">
            <div class="container_img">
                <div class="large_img">
                    <img src="../../asset/images/computer_glasses/cg1.png" alt="cg">
                </div>
                <div class="small_img">
                    <img src="../../asset/images/computer_glasses/cg1.png" alt="">
                    <img src="../../asset/images/computer_glasses/cg12.png" alt="">
                    <img src="../../asset/images/computer_glasses/cg13.png" alt="">
                    <img src="../../asset/images/computer_glasses/cg14.png" alt="">
                </div>
            </div>
            <div class="product_detail">
                <p id="signa">Signa</p>
                <p class="h_three">SKU: SM IPA1608</p>
                <p>Specsmakers Signa Women Eyeglasses Fullframe Cateye Large<br> 52 Shell SM IPA1608 <br>₹ 1,990</p>
                <p class="h_three">COLOR : black and blue</p>
