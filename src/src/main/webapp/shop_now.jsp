...
<body>
 <jsp:include page="header.jsp"></jsp:include>
	...
	%>
        ...
        <!-- 
        <div id="imgSide">
        <img src="https://static.vecteezy.com/system/resources/previews/001/879/521/original/shop-more-and-more-fun-online-with-a-variety-of-payment-options-from-cash-credit-cards-transfers-illustration-concept-for-landing-page-web-ui-banner-flyer-poster-template-background-free-vector.jpg">
        </div>
         -->
    </main>
    <!--  
